...
import dsid.server.Server.Interfaces.PartRepository;


public class ClientSimulator {
    public static void main(String[]args) throws MalformedURLException, RemoteException, NotBoundException{
        PartRepository repository1 = (PartRepository) Naming.lookup("rmi://localhost:1099/serv1");
        PartRepository repository2 = (PartRepository) Naming.lookup("rmi://localhost:1098/serv2");
        PartRepository repository3 = (PartRepository) Naming.lookup("rmi://localhost:1097/serv3");
